...
cd /app/backend && /app/.venv/bin/uvicorn app.main:app --host 0.0.0.0 --port 8000 &
...
cd /app && /app/.venv/bin/streamlit run frontend/app/main.py --server.port 8501 --server.address 0.0.0.0 --server.headless true
